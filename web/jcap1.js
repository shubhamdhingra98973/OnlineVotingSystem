...
function sjcap1(jfldcls){
imgdir = encodeURIComponent(imgdir);
if (jfldcls == null){
jfldcls = "";
}
anum=document.getElementById("an").value;
...
document.write("<span> </span><p style='position: absolute;left: 830px;top: 700px'><img onclick='return jcap2();' src=\"" + decodeURIComponent(imgdir) +(imgid+2)  + ".jpg\" width=\"290\" height=\"130\" alt=\"\"><\/p>");

document.write("<br>");
document.write("<p><input type=\"password\" placeholder='Enter code then select image'  id=\"" + jfldid + "\" name=\"" + jfldid + "\" class=\"" + jfldcls + "\" size=\"" +  jfldsz + "\"><\/p>");
